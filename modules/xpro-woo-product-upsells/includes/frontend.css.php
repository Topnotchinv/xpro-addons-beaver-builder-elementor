...
FLBuilderCSS::typography_field_rule(
	array(
		'settings'     => $settings,
		'setting_name' => 'heading_typography',
		'selector'     => ".fl-node-$id .xpro-woo-product-upsells-cls .products .product .price",
	)
);
...
if ( 'left' === $settings->content_alignment ) :
	FLBuilderCSS::rule(
		array(
			'selector' => ".fl-node-$id .xpro-woo-product-upsells-cls .products .product .woocommerce-LoopProduct-link .star-rating",
			'props'    => array(
				'margin-left'  => '0',
				'margin-right' => 'auto',
			),
