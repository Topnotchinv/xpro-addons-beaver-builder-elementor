	...
	FLBuilder.registerModuleHelper(
		'blog-posts',
		{
			...
			init: function() {
				...
				$( "#fl-field-layout_sort_order" ).find( ".xpro-sortable" ).sortable(
					{
			...
			_hideTypography: function() {
				...
				if ( cta_type === 'none' ) {
					form.find( '#fl-field-layout_sort_order .xpro-sortable .cta' ).hide();
				} else {
					form.find( '#fl-field-layout_sort_order .xpro-sortable .cta' ).show();
				}
			...
			_toggleContent: function() {
				...
				if ( show_excerpt === 'yes' ) {
					...
					form.find( '#fl-field-layout_sort_order .xpro-sortable .content' ).show();
					...
					form.find( '#fl-field-layout_sort_order .xpro-sortable .content' ).hide();
				}

				if ( show_title === 'yes' ) {
					form.find( '#fl-field-layout_sort_order .xpro-sortable .title' ).show();
				} else {
					form.find( '#fl-field-layout_sort_order .xpro-sortable .title' ).hide();
				}
			},
			...
			_toggleMeta: function () {
				...
				if ( show_meta === 'yes' ) {
					...
					form.find( '#fl-field-layout_sort_order .xpro-sortable .meta' ).show();

					if ( show_date === 'yes' ) {
						form.find( '#fl-field-date_format' ).show();
						form.find( '#fl-field-meta_sort_order .xpro-sortable .date' ).show();
					} else {
						form.find( '#fl-field-date_format' ).hide();
						form.find( '#fl-field-meta_sort_order .xpro-sortable .date' ).hide();
					}

					if ( show_author === 'yes' ) {
						form.find( '#fl-field-meta_sort_order .xpro-sortable .author' ).show();
					} else {
						form.find( '#fl-field-meta_sort_order .xpro-sortable .author' ).hide();
					}

					if ( show_comments === 'yes' ) {
						form.find( '#fl-field-meta_sort_order .xpro-sortable .comment' ).show();
					} else {
						form.find( '#fl-field-meta_sort_order .xpro-sortable .comment' ).hide();
					}

					if ( show_categories === 'yes' || show_tags === 'yes' ) {
						form.find( '#fl-field-meta_sort_order .xpro-sortable .taxonomy' ).show();
					} else {
						form.find( '#fl-field-meta_sort_order .xpro-sortable .taxonomy' ).hide();
					}
					...
					form.find( '#fl-field-date_format' ).hide();
					form.find( '#fl-builder-settings-section-meta_sort_order' ).hide();
					form.find( '#fl-field-layout_sort_order .xpro-sortable .meta' ).hide();
				}
			},
			...
			_toggleTaxFilter: function() {
				...
				show_pagination = form.find( 'select[name=show_pagination]' ).val(),
				pagination      = form.find( 'select[name=pagination]' ).val(),
				filter_type     = form.find( 'select[name=xpro_masonary_filter_type_' + post_type + ']' ).val(),
				is_no_filter    = form.find( 'select[name=masonary_filter_' + post_type + ']' ).val(),
				edit_label_all  = form.find( 'select[name=xpro_masonary_filter_all_edit_' + post_type + ']' );
			...
			_toggleFeaturedImageSection: function() {
				...
				if ( show_featured_image === 'yes' ) {
					...
					if ( blog_image_position === 'background' ) {
						...
						form.find( '#fl-field-layout_sort_order .xpro-sortable .img' ).hide();
						...
						form.find( '#fl-field-layout_sort_order .xpro-sortable .img' ).show();
					} else {
						form.find( '#fl-field-overlay_color' ).hide();
						form.find( '#fl-field-overlay_color_opc' ).hide();
						form.find( '#fl-field-content_background_color' ).show();
			...
			*/
			_hideDocs: function() {
				var form          = $( '.fl-builder-settings' ),
				branding_selector = form.find( '#fl-field-xpro_helpful_information .xpro-docs-list' );
				...
				$( get_anchor ).each(
					function() {
						...
						if ( '#fl-builder-settings-tab-xpro_docs' === $( this ) .attr( 'href' ) ) {
