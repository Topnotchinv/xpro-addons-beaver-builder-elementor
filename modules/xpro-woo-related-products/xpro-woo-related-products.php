...
if (class_exists('WooCommerce')) {
	class XproWooRelatedProductModule extends FLBuilderModule
	{
		...
		public function __construct()
		{
			parent::__construct(array(
				...
				'description' 	  => __('Displays related product.', 'xpro-bb-addons'),
				'group'           => XPRO_Plugins_Helper::$branding_modules,
				'category'        => XPRO_Plugins_Helper::$themer_modules,
				'dir'             => XPRO_ADDONS_FOR_BB_DIR . 'modules/xpro-woo-related-products/',
				'url'             => XPRO_ADDONS_FOR_BB_URL . 'modules/xpro-woo-related-products/',
	...
	class XproWooRelatedProductModuleNotExist extends FLBuilderModule
	{
		/**
		 * @return void
		 */
...
if (class_exists('WooCommerce')) {
				...
				'rating_section' => array(
					...
					'fields' => array(
						...
						'rating_size' => array(
							...
							'preview'    => array(
								'type'      => 'css',
								'selector'  => '.xpro-woo-related-product-cls .products .product .star-rating',
								'property'  => 'font-size',
								'unit'      => 'px',
								'important' => true,
							),
				...
				'badge_section' => array(
					...
					'fields' => array(
						'badge_color' => array(
							...
							'preview'    => array(
								'type'     => 'css',
								'selector' => '.xpro-woo-related-product-cls .products .product .onsale',
								'property' => 'color',
							),
						),
				...
				'title'       => array(
					...
					'fields'        => array(
						'heading_typography' => array(
							...
							'preview'    => array(
								'type'      => 'css',
								'selector'  => '.xpro-woo-related-product-cls .related h2:first-child',
							),
						),
						'title_typography' => array(
							...
							'preview'    => array(
								'type'      => 'css',
								'selector'  => '.xpro-woo-related-product-cls .products .product .woocommerce-loop-product__title',
							),
						),
						'price_typography' => array(
							...
							'preview'    => array(
								'type'      => 'css',
								'selector'  => '.xpro-woo-related-product-cls .products .product .price',
							),
						),
						'sale_price_typography' => array(
							...
							'preview'    => array(
								'type'      => 'css',
								'selector'  => '.xpro-woo-related-product-cls .products .product del .woocommerce-Price-amount',
							),
						),
						...
						'btn_typography' => array(
							...
							'preview'    => array(
								'type'      => 'css',
								'selector'  => '.xpro-woo-related-product-cls .products .product .button, .xpro-woo-related-product-cls .related .products a.add_to_cart_button',
							),
						),
					)
				),
	...
	FLBuilder::register_module('XproWooRelatedProductModuleNotExist', array(
		'general-info' => array(
			'title' => __('General', 'xpro'),
