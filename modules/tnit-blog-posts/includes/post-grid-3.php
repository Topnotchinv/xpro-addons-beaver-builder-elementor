<div class="xpro-item">
	...
	<div class="tnit-blog-item">
		<figure class="tnit-blog-thumb">
			...
			<figcaption class="tnit-blog-caption">
				<!--Content Start-->
				<div class="tnit-blog-content">
					<?php if ( $settings->show_categories ) : ?>
					<div class="tnit-post-categories-outer">
					...
					<div class="tnit-post-author-outer">
						<ul class="tnit-post-meta-list">
							<li class="tnit-post-author">
								...
								printf(
									...
									_x( '%s', '%s stands for author name.', 'xpro-bb-addons' ),
					...
					<div class="tnit-post-content-footer">
						...
						<div class="tnit-post-comment-outer">
							<ul class="tnit-post-meta-list">
				...
				<div class="tnit-post-date-outer">
					<ul class="tnit-post-meta-list">
						<li class="tnit-post-date">
							<span><?php FLBuilderLoop::post_date( 'd M' ); ?></span>
						</li>
					</ul>
				</div>
				<?php endif; ?>
