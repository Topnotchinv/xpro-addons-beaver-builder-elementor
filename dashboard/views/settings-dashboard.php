<div class="xpro-bb-tab-content active" id="bb-dashboard">
	<div class="xpro-row">
		<div class="xpro-col-lg-9">
			<div class="xpro-bb-content-wrapper">
				<div class="xpro-bb-dashboard-tab-content-inner xpro-bb-dashboard">
					<div class="xpro-bb-dashboard-intro">
						<div class="xpro-bb-dashboard-intro-content">
							<h5 class="xpro-bb-dashboard-label">Design What You Love</h5>
							<h2 class="xpro-bb-dashboard-title">The Most <span class="xpro-pink">Premium</span> Beaver Builder Addons</h2>
			...
			<div class="xpro-bb-content-wrapper">
				<div class="xpro-bb-dashboard-tab-content-inner xpro-bb-dashboard">
					<div class="xpro-bb-dashboard-intro">
						<div class="xpro-bb-dashboard-intro-content">
							<h2 class="xpro-bb-dashboard-title">Highly <span class="xpro-pink">Advanced</span> & <span class="xpro-pink">Intuitive</span> Slider for Beaver Builder</h2>
							<p class="xpro-bb-dashboard-txt">
						...
						<div class="xpro-bb-dashboard-sidebar xpro-bb-dashboard-sidebar-slider">
							<div class="xpro-bb-dashboard-modules-wrapper">
								<div class="xpro-bb-dashboard-modules-carousel owl-carousel1 xpro-bb-dashboard-modules-slider-carousel owl-carousel">
									<div class="xpro-bb-dashboard-modules-item">
										<div class="xpro-bb-dashboard-intro-image">
											<img src="<?php echo esc_url( XPRO_ADDONS_FOR_BB_URL . 'assets/images/slider-f1.png' ); ?>" alt="">
										</div>
										<div class="xpro-bb-dashboard-label">Drag & Drop<br> <span class="xpro-pink">Slider</span></div>
									</div>
									<div class="xpro-bb-dashboard-modules-item">
										<div class="xpro-bb-dashboard-intro-image">
											<img src="<?php echo esc_url( XPRO_ADDONS_FOR_BB_URL . 'assets/images/slider-f2.png' ); ?>" alt="">
										</div>
										<p class="xpro-bb-dashboard-label">Add<br> <span class="xpro-pink">Unlimited Slides</span></p>
									</div>
									<div class="xpro-bb-dashboard-modules-item">
										<div class="xpro-bb-dashboard-intro-image">
											<img src="<?php echo esc_url( XPRO_ADDONS_FOR_BB_URL . 'assets/images/slider-f1.png' ); ?>" alt="">
										</div>
										<p class="xpro-bb-dashboard-label">Adjust<br> <span class="xpro-pink">Slide Duration</span></p>
									</div>
									<div class="xpro-bb-dashboard-modules-item">
										<div class="xpro-bb-dashboard-intro-image">
											<img src="<?php echo esc_url( XPRO_ADDONS_FOR_BB_URL . 'assets/images/slider-f2.png' ); ?>" alt="">
										</div>
										<p class="xpro-bb-dashboard-label">Control<br> <span class="xpro-pink">Layer Position</span></p>
									</div>
								</div>
							</div>
						</div>
			...
			<div class="xpro-bb-content-wrapper xpro-bb-dashboard-filter-gallery">
				<div class="xpro-bb-dashboard-tab-content-inner">
					<div class="xpro-bb-dashboard-intro">
						<div class="xpro-bb-dashboard-intro-content">
							<h2 class="xpro-bb-dashboard-title">The Most <span class="xpro-pink">Advanced Gallery</span> for beaver builder</h2>
							<p class="xpro-bb-dashboard-txt">
								Experience the modern drag’n’drop gallery addon & create fully customizable, beautiful, and mobile-friendly galleries within minutes.
							</p>
							<a href="https://beaver.wpxpro.com/filterable-gallery/" target="_blank" class="xpro-bb-dashboard-btn xpro-bb-btn-document xpro-btn-underline">Get started</a>
						</div>
						<div class="xpro-bb-dashboard-intro-image xpro-bb-dashboard-filter-image">
							<img src="<?php echo esc_url( XPRO_ADDONS_FOR_BB_URL . 'assets/images/filterable-gallery.png' ); ?>" alt="">
						</div>
					</div>
				</div>
			</div>
			<div class="xpro-bb-content-wrapper xpro-bb-dashboard-filter-gallery">
				<div class="xpro-bb-dashboard-tab-content-inner">
					<div class="xpro-bb-dashboard-intro">
						<div class="xpro-bb-dashboard-intro-content">
							<h2 class="xpro-bb-dashboard-title">The Most Powerful <span class="xpro-pink">Portfolio</span> Plugin for Beaver Builder</h2>
							<p class="xpro-bb-dashboard-txt">
		...
		<div class="xpro-col-lg-12">
			<div class="xpro-bb-content-wrapper xpro-bb-dashboard-feedback">
				<div class="xpro-bb-dashboard-tab-content-inner">
					<div class="xpro-bb-dashboard-intro">
						<div class="xpro-bb-dashboard-intro-content">
							<h2 class="xpro-bb-dashboard-title">Like Our Work?</h2>
							<p class="xpro-bb-dashboard-txt">
